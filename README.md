...
<head>
    ...
    <meta name="keywords" content="MRX的主页">
    ...
    <script>
        ...
        (function () {
            ...
            hm.src = "https://hm.baidu.com/hm.js?3571b09c10ce78da48211dc5093ddf8a";
    ...
    <div id="loading-box">
        ...
        <div class="spinner-box">
            ...
            <div class="loading-word">
                <p class="loading-title" id="loading-title">MRX的主页</p>
            ...
            <div class="container" id="container">
                <div class="row" id="row">
                    <div class="col left">
                        ...
                        <div class="main-left">
                            ...
                            <div class="main-img">
                                ...
                                <div class="img-title">
                                    <span class="img-title-big" id="logo-text-1">slass</span>
                                    <span class="img-text" id="logo-text-2">.cc</span>
                                </div>
                            </div>
                            <!--介绍信息-->
                            <div class="message cards" id="switchmore">
                                <div class="des" id="des">
                                    ...
                                    <div class="des-title"><span id="change">Hello&nbsp;World&nbsp;!</span><br /><span
                                            id="change1">欢迎来到通往新世界的大门</span></div>
                                    <i class="fa-solid fa-quote-right"></i>
                                </div>
                            </div>
                            <!--社交链接-->
                            <div class="social" id="social">
                                <a href="https://github.com/mrx-j0bs" class="link" id="github" style="margin-left: 4px"
                                    target="_blank">
                                    <i class="fa-brands fa-github"></i>
                                </a>
                                <a href="mailto:mrx_jobs_666@icloud.com" class="link" id="email">
                                    <i class="fa-solid fa-envelope"></i>
                                </a>
                                <a href="https://space.bilibili.com/1538149000" class="link" id="bilibili"
                                    target="_blank">
                    ...
                    <div class="logo cards" style="display: none" id="changemore">
                        <a class="logo-text" id="logo-text-small">slass.cc</a>
                    </div>
                    <div class="col right">
                        <div class="main-right">
                                ...
                                <div class="col hitokotos">
                                    ...
                                    <div class="hitokoto cards" id="hitokoto">
                                        ...
                                        <div class="hitokoto-all">
                                            <div class="hitokoto-text"><span id="hitokoto_text">求知若渴 知贤若愚</span>
                                            </div>
                                            <div class="hitokoto-from">-「&nbsp;<span id="from_text">MRX的主页</span>&nbsp;」
                                            </div>
                                        </div>
                                    </div>
                                    <!--音乐-->
                            ...
                            <div class="link">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <a id="link-url-1" href="https://mrxblog.ml" target="_blank">
                ...
                <div class="more" id="more">
                    ...
                    <div class="line">
                        <i class="fa-solid fa-angle-left"></i>
                        <span class="line-text">我的传送门</span>
                        <i class="fa-solid fa-angle-right"></i>
                    </div>
                    <!-- 网站链接 -->
                    <div class="row">
                        <div class="col">
                            <a href="https://www.slass.cc/" target="_blank">
                                <div class="link-card cards">
                                    <span class="link-name">站点监测(建设中)</span>
                                </div>
                            </a>
                        </div>
                        <div class="col 2">
                            <a href="" target="_blank">
                                <div class="link-card cards">
                                    <span class="link-name">网易云音乐</span>
                                </div>
                            </a>
                        </div>
                        <div class="col">
                    ...
                    <div class="row" style="margin-top: 1.5rem;">
                        <div class="col">
                            ...
                            <a href="" target="_blank">
                                <div class="link-card cards">
                                    <span class="link-name">影视中心</span>
                                </div>
                            </a>
                        </div>
                        <div class="col 2">
                            <a href="" target="_blank">
                                <div class="link-card cards">
                                    <span class="link-name">青龙面板</span>
                                </div>
                            </a>
                        </div>
                        <div class="col">
                ...
                <div class="box" id="box" style="display: none">
                    <div class="box-wrapper">
                        ...
                        <div class="box-left">
                            <div class="img-title">
                                <span class="img-title-big" id="logo-title-other">slass</span>
                                <span class="img-text" id="logo-title-other-small">.cc</span><br />
                                <span class="img-text">&nbsp;link&nbsp;-></span>
                                <a href="https://github.com/poshoi" target="_blank">
                                    <i class="fa-brands fa-github"></i>
                                </a>
                            </div>
                            <!--更多内容-->
        ...
        <footer id="footer" class="fixed-bottom footer">
            <div class="power">
                <span id="power">Copyright&nbsp;&copy;
                    ...
                    <a href="https://www.slass.cc" id="power-text">MRX的主页</a>
                </span>
                <!-- 以下信息请不要修改哦 -->
                <span id="made">&amp;&nbsp;Made&nbsp;by&nbsp;<a href="https://github.com/poshoi"
                        target="_blank">imsyy</a></span>
                <!-- 站点备案 -->
                <a href="https://beian.miit.gov.cn" id="beian" target="_blank">&amp;&nbsp;</a>
            </div>
            <!-- 歌词显示 -->
            <div id="lrc"></div>
        </footer>
